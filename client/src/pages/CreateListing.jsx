  ...
  const handleImageSubmit = (e) => {
    if (files.length > 0 && files.length + formData.imageUrls.length < 7) {
      ...
      Promise.all(promises)
        ...
        .catch((err) => {
          setImageUploadError('Không thể đăng ảnh! (Dung lượng ảnh tối đa 2MB)');
          setUploading(false);
        });
    } else {
      setImageUploadError('Chỉ có thể đăng tối đa 6 ảnh!');
      setUploading(false);
    }
  };
        ...
        <div className='flex flex-col flex-1 gap-4'>
          <p className='font-semibold'>
            ...
            <span className='font-normal text-gray-600 ml-2'>
              Tối đa 6 ảnh (Ảnh đầu tiên sẽ làm ảnh bìa)
            </span>
          </p>
          ...
          >
            {loading ? 'Đang đăng...' : 'Đăng bán/thuê'}
          </button>
